...
To create a cache, first sign in to the [Windows Azure portal][], and click **New**, **Data + Storage**, **Redis Cache**.

![New cache][NewCacheMenu]

>[AZURE.NOTE] If you don't have an Azure account, you can create a free trial account in just a couple of minutes. For details, see [Azure Trial][].
