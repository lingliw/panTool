...
Note: you can use a parameter object to specify parameters. See [Deploy resources with Azure Resource Manager templates](https://azure.microsoft.com/en-us/documentation/articles/resource-group-template-deploy/) for more details.
