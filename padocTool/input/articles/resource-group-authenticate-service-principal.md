...
- To learn about using the portal with service principals, see [Create a new Azure Service Principal using the Azure portal](/documentation/articles/resource-group-create-service-principal-portal)  
