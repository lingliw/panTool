...
To learn more about VPN gateways, see [About VPN gateways](vpn-gateway-about-vpngateways).

To configure a site-to-site VPN, see [Create a virtual network with a site-to-site VPN connection](vpn-gateway-site-to-site-create).
