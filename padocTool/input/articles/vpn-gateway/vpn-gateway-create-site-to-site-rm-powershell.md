...
- A compatible VPN device (and someone who is able to configure it). See [About VPN Devices](/documentation/articles/vpn-gateway-about-vpn-devices).
...
- An Azure subscription. If you don't already have an Azure subscription, you can sign up for a [Azure trial](http://www.windowsazure.cn/pricing/1rmb-trial/).
...
At this time, the site-to-site VPN connections created with Resource Manager are not visible in the Preview Portal. However, it's possible to verify that your connection succeeded by using *get-azurevirtualnetworkgatewayconnection ¨CDebug*. In the future, we'll have a cmdlet for this, as well as the ability to view your connection in the Preview Portal.
...
Add a virtual machine to your virtual network. [Create a Virtual Machine](/documentation/articles/virtual-machines-windows-tutorial).