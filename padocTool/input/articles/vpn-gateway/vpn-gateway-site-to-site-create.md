<properties
   pageTitle="Create a virtual network with a site-to-site VPN connection using the Azure portal | Windows Azure"
...
- An Azure subscription. If you don't already have an Azure subscription, you can activate your sign up for a [free trial](http://www.windowsazure.cn/pricing/free-trial/).
