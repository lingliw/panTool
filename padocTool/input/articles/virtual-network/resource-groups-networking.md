...
You can check the individual properties of resources in the sections below.## Public IP address
...
![NIC's on a single VM](../../includes/media/resource-groups-networking/Figure3.png)
...
![VNet with multiple subnets](../../includes/media/resource-groups-networking/Figure4.png)
...
![NIC's on a single VM](../../includes/media/resource-groups-networking/figure8.png)
