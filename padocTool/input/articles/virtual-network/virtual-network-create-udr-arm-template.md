...
#Create User Defined Routes (UDR) using a template
 ...
 This article covers the Resource Manager deployment model. You can also [create UDRs in the classic deployment mode](/documentation/articles/virtual-networks-udr-how-to).
