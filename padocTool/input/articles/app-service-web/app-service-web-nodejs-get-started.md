...
2. Set the two following parameters: 
    ...
    Together, they tell iisnode in Azure Web App to put its stdout and stderror output in the D:\home\site\wwwroot\**iisnode** directory.
...
6. Click the **Edit** icon for the log you want to read. You can also click **Download** or **Delete** if you want.
    ...
    Now you can see the log to help you debug your Azure Web App deployment.
