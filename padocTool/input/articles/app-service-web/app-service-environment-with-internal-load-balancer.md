...
- buying and using a certificate with an app through the portal.  You can of course still obtain certificates directly with a Certificate Authority and use it with your apps, just not through the Azure Portal Preview.
...
1.	In the Azure Portal Preview select **New -> Web + Mobile -> App Service Environment**
...
1. In the Azure Portal Preview select **New -> Web + Mobile -> Web** or **Mobile** or **API App**
2. Enter name of app
