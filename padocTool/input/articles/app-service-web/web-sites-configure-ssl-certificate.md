...
following requirements:
	...
	used by your CA. Otherwise, you may run into irreproducible interoperability problems on some clients.
		...
		[buy one in the Azure Portal Preview directly](/documentation/articles/web-sites-purchase-ssl-web-site/). This article shows you 
		how to do it manually and then bind it to your custom domain in App Service.
		><p> **Elliptic Curve Cryptography (ECC) certificates** can work with App Service, but outside the scope
