...
In the Azure you can connect your app (web, mobile or API) to a VNET in your subscription.  This feature is called VNET Integration.  The VNET Integration feature should not be confused with the Azure Environment feature which allows you to run an instance of the Azure in your VNET. 
...
1. An App in the Azure running in a Standard or Premium SKU
...
The app location should be the location without any spaces, e.g. China North is chinanorth
...
Or in Azure Classic Portal, click **Networks** > **You Vnet** > **Certificates** > **Upload**.
...
###V2 VNET Azure integration script###
