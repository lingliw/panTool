...
**Note:** Network security groups can be configured graphically using the [Azure Portal Preview](https://portal.azure.cn) or through Azure PowerShell.
