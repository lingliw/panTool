...
* For a guide to the change of the old portal to the new portal see: [Reference for navigating the Azure Portal Preview](https://manage.windowsazure.cn/)
