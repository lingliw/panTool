...
You can manage and monitor your App Service Environment by using the UI in the Azure Portal Preview. If you have an ASE, then you are likely to see the App Service symbol on your sidebar. This symbol is used to represent App Service Environments in the Azure Portal Preview:
