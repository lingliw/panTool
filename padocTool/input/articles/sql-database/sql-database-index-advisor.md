...
Index advisor provides a list of index recommendations on the database blade in the [Azure Portal](https://manage.windowsazure.cn/). The top selected recommendations are shown for each table in the selected database where creating a new index may provide performance gains.
