...
1. Open a web browser, and browse to [http://www.windowsazure.cn](http://www.windowsazure.cn). To get started with a free account, click free trial in the upper right corner and follow the steps.
...
Now that you have learned the basics of connecting to SQL Database, see [Development: How-to Topics (SQL Database)](http://msdn.microsoft.com//zh-cn/library/windowsazure/ee621787.aspx)
