...
A new [Windows Azure portal](https://manage.windowsazure.cn) is available to support your upgrade to V12.
...
You can reduce the steps necessary during upgrade by switching your V11 database away from the Web-and-Business tier before you start the upgrade. You can do this by using the new [Windows Azure portal](https://manage.windowsazure.cn).
...
You can export or import a V12 database by using the [Windows Azure portal](https://manage.windowsazure.cn). Or you can export or import by using any of the following tools:
...
- Microsoft Azure [Preview features](/home/features/preview/)
