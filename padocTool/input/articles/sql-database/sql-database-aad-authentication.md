...
If your database is not hosted in SQL Database V12, see [Plan and prepare to upgrade to SQL Database V12](/documentation/articles/sql-database-v12-plan-prepare-upgrade), and then visit the Azure Portal to migrate the database to SQL Database V12.
...
1. Connect to your [Azure portal](https://manage.windowsazure.cn/) by using an Azure subscription administrator.
