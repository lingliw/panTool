...
This tutorial shows you how to restore a deleted Azure SQL database in the [Azure portal](http://manage.windowsazure.cn/). You can restore a database that was deleted during its retention period to the point it was deleted. The retention period is determined by the service tier of the database.
...
1. Sign in to the [Azure portal](http://manage.windowsazure.cn) using your Microsoft account.
