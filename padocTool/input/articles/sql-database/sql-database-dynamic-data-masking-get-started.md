...
> [AZURE.SELECTOR]
- [Dynamic Data Masking - Azure portal](/documentation/articles/sql-database-dynamic-data-masking-get-started-portal)
...
1. Launch the Azure portal at [http://manage.windowsazure.cn](http://manage.windowsazure.cn).
