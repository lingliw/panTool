...
Now that you know about the SQL Database tiers, try them out with a [free trial](/pricing/1rmb-trial/) and learn [how to create your first SQL database](/documentation/articles/sql-database-get-started)!
