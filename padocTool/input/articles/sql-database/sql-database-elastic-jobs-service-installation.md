...
## Prerequisites
* An Azure subscription. For a free trial, see [trial](/pricing/1rmb-trial/).
...
1. From the dashboard view of the elastic database pool via the [Azure portal](https://manage.windowsazure.cn) , click **Create job**.
