...
For information about Event Hubs pricing, see the [Event Hubs pricing details](/pricing/details/event-hubs).
...
[queued messaging solution]: /documentation/articles/cloud-services-dotnet-multi-tier-app-using-service-bus-queues.md
