...
This tutorial shows how to run both front-end and back-end in an Azure cloud service. An alternative is to run the front-end in an [Azure  Website](/services/web-sites/) and use the [WebJobs](/documentation/articles/websites-webjobs-resources/) feature (currently in preview) for the back-end. For information about how to choose the services that best fit your scenario, see [Azure  Websites, Cloud Services, and Virtual Machines Comparison](/documentation/articles/choose-web-site-cloud-service-vm).
...
1. In your browser, open the [Azure Portal](http://manage.windowsazure.cn).
...
1. In the [Azure portal](http://manage.windowsazure.cn), click **New > Data Services > SQL Database > Quick Create**.
...
1. In the [Azure portal](http://manage.windowsazure.cn), click **New > Data Services > Storage > Quick Create**.
...
2. In the [Azure portal](http://manage.windowsazure.cn), click **SQL Databases** in the left pane, click the database you created for this tutorial, click the **Dashboard** tab, and then click **Show connection strings**.
...
3. In the **Settings** step of the wizard, click **Next**.
	...
	The default settings in the **Advanced** tab are fine for this tutorial. For information about the advanced tab, see [Publish Azure Application Wizard](http://msdn.microsoft.com/zh-cn/library/windowsazure/hh535756.aspx).
