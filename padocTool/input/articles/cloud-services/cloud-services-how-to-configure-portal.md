...
1. In the [Azure Portal](https://manage.windowsazure.cn), navigate to your cloud service.
...
>[AZURE.NOTE]
>The operating system used for the cloud service cannot be changed using the **Azure Portal**, you can only change this setting through the [Azure Portal](https://manage.windowsazure.cn). This is detailed [here](cloud-services-how-to-configure.md#update-a-cloud-service-configuration-file).
