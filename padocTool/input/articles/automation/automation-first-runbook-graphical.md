...
- Azure subscription. If you don't have one yet, you can <a href="/pricing/1rmb-trial/" target="_blank">[sign up for a trial](/pricing/1rmb-trial/).
...
- [Azure Active Directory user and Credential asset](/documentation/articles/automation-configuring) to authenticate to Azure resources.  This user must have permission to start and stop the virtual machine.
