...
For more information about integrating your on-premises directory with Azure AD, see [Directory integration](active-directory-aadconnect).
...
- [Assigning administrator roles in Azure AD](active-directory-assign-admin-roles)
