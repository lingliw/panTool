...
Azure AD administration portal is a part of the Azure Management Portal. While using Azure AD does not require any Azure purchases, accessing this portal requires an active Azure subscription or an [Azure trial subscription](http://www.windowsazure.cn/pricing/1rmb-trial/).
...
> [Learn more about Azure AD service levels](http://azure.microsoft.com/zh-cn/support/legal/sla/)
