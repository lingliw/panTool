...
Developers can also manage the keys directly, by using  APIs. For more information, see [Key Vault REST API](https://msdn.microsoft.com/zh-cn/library/azure/dn903609.aspx) and [Key Vault C# Client API Reference](https://msdn.microsoft.com/zh-cn/library/azure/dn903628.aspx).
