...
4. Type:
   ...
   For more information, see [Get Started with Microsoft Azure Cmdlets](https://msdn.microsoft.com/zh-CN/library/windowsazure/jj554332.aspx) 

   For more information on installing and configuring PowerShell, see [How to install and configure Microsoft Azure PowerShell](/documentation/articles/install-configure-powershell). 
