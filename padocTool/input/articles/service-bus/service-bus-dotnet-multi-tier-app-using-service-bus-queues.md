...
To learn how to deploy the front end to an Azure website, see [Create an ASP.NET web app in Azure App Service](/documentation/articles/app-service-web/web-sites-dotnet-get-started). To learn how to deploy the back end to an Azure cloud service, see [.NET Multi-Tier Application Using Storage Tables, Queues, and Blobs][mutitierstorage].
