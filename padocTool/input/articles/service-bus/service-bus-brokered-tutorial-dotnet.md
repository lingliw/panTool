...
2. In the main window of the Azure portal, click the name of the namespace you created in the previous step.
...
2. Open a browser and go to the [Azure portal](http://manage.windowsazure.cn).
