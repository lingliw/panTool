...
To use Office 365 Shared Computer Activation, you need to create a [custom template](/documentation/articles/remoteapp-create-custom-image) and install Office 365 ProPlus there, following [these directions](https://technet.microsoft.com/library/dn782858.aspx).
