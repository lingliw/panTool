...
3. Now you need to create an Azure [storage account](/documentation/articles/storage-create-storage-account). We named ours "accessstorage," so pick a name that's meaningful to you (there can be only one "accessstorage").
