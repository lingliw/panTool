...
+ Control characters: [0x0000-0x001F] and [0x007F-0x009F]. For more information, see [ASCII control codes C0 and C1](http://zh.wikipedia.org/wiki/Data_link_escape_character#C1_set).
...
[Validate and modify data in Mobile Services by using server scripts]: /zh-cn/documentation/articles/mobile-services-windows-store-dotnet-validate-modify-data-server-scripts/
[Commands to manage Azure Mobile Services]: /zh-cn/documentation/articles/command-line-tools/#Commands_to_manage_mobile_services/#Mobile_Scripts
...
[Call a custom API from the client]: /zh-cn/documentation/articles/mobile-services-windows-store-dotnet-call-custom-api/#define-custom-api
...
[Leverage shared code and Node.js modules in your server scripts]: /zh-cn/documentation/articles/mobile-services-store-scripts-source-control/#use-npm
