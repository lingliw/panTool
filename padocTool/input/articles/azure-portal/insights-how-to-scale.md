...
In the [Azure Portal](https://manage.windowsazure.cn/), you can manually set the instance count of your service, or, you can set parameters to have it automatically scale based on demand. This is typically referred to as *Scale out* or *Scale in*.
...
1. In the [Azure Portal](https://manage.windowsazure.cn/), click **Browse**, then navigate to the resource you want to scale, such as a **App Service plan**.
