...
>例如，如果你使用的是 Azure PowerShell 1.0.0 或者 1.0.1，应变为 `$china = Get-AzureRmEnvironment -Name AzureChinaCloud; Login-AzureRmAccount -Environment $china`，或者，如果你使用的是 Azure PowerShell 1.0.2 或者 更高：`Login-AzureRmAccount -EnvironmentName AzureChinaCloud`
> 
...
<!---HONumber=79--> [Resource Manager model](/documentation/articles/cache-howto-manage-redis-cache-powershell)本文开头介绍的。
