...
Traffic Manager billing has two components: endpoint health checks and millions of DNS queries (for full details, see our [pricing page](/home/features/traffic-manager/#price).) Here's how this applies to Nested profiles:
