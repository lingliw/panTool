<properties
   pageTitle="Azure Service Fabric Application Life-cycle | Windows Azure"
...
See [Get started with Reliable Actors](service-fabric-reliable-actors-get-started.md) and [Get started with Reliable Services](documentation/articles/service-fabric-reliable-services-quick-start) for examples.
