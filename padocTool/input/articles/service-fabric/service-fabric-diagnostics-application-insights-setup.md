...
This article assumes you have a Service Fabric application already created in Visual Studio. To find out how [click here](/documentation/articles/service-fabric-reliable-services-quick-start).
...
You can learn about the events emitted from the Reliable Actors runtime [here](/documentation/articles/service-fabric-reliable-actors-diagnostics) and Reliable Services runtime [here](/documentation/articles/service-fabric-reliable-services-diagnostics).
...
An instrumentation key is what ties your Service Fabric app to your Application Insights resource.  You can learn how to get your instrumentation key by following [Application Insight's guide](/documentation/articles/app-insights-create-new-resource#create-an-application-insights-resource).
...
## Viewing data
You can [customize the App Insights blade](/documentation/articles/app-insights-metrics-explorer) to fit your needs. 
...
- [Getting started with Application Insights](/documentation/articles/app-insights-get-started)
- [Learn to create your own custom events and metrics](/documentation/articles/app-insights-custom-events-metrics-api)
