...
>[AZURE.NOTE] Please see [IP Address pricing](/pricing/details/reserved-ip-addresses) for information on pricing on VIPs and reserved IPs.
...
>[AZURE.NOTE] Your subscription will only be charged for extra VIPs once they are associated with an endpoint. For more information on pricing, see [IP Address pricing](/pricing/details/reserved-ip-addresses).
