...
You can create a VM Scale Set in the [Azure portal Preview](https://portal.azure.cn) by selecting _new_ and typing in "scale" in the search bar. You will see "Virtual machine scale set" in the results. From there you can fill in the required fields to customize and deploy your scale set. 
...
The [Azure portal Preview](https://portal.azure.cn) lists scale sets and shows basic properties, as well as listing VMs in the set.
