...
- You'll need a [Windows Azure](http://www.windowsazure.cn/) account. You'll need a [Windows Azure](http://www.windowsazure.cn/) account. You can start with a [free trial](pricing/free-trial/). In addition, you can read about [Azure Site Recovery Manager pricing](/pricing/details/site-recovery/).
