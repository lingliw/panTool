...
:------------- | :------------- | 
[I use it with Office 365](/documentation/articles/multi-factor-authentication-end-user-manage-o365)|  This means that you will want to create app passwords through the Office 365 portal.
[I use it with Microsoft Azure](/documentation/articles/multi-factor-authentication-end-user-manage-azure)| This means that you will want create app passwords through the Azure portal.
[I don't know](/documentation/articles/multi-factor-authentication-end-user-manage-myapps)|This means you will want create app passwords through [https://myapps.microsoft.com](https://myapps.microsoft.com)
